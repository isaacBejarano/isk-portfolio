...
export const store = {
	...
	get getScroll(): Indexed {
		return this.scroll;
	},
	get getMasterhead(): Indexed {
		return this.masterhead;
	},
	get getNew(): Indexed {
		return this.new;
	},
	get getPortfolio(): Indexed {
		return this.portfolio;
	},
	get getPortfolioItems(): Indexed[] {
		return this.portfolio.items;
	},
	get getPortfolioCommon(): Indexed {
		return this.portfolio.common;
	},
	// TECH
	get getSkillsLang(): Indexed {
		return this.skills.lang;
	},
	get getSkillsStack(): Indexed {
		return this.skills.getStack;
	},
	get getSkillsFrontend(): Indexed {
		return this.skills.frontend;
	},
	get getSkillsBackend(): Indexed {
		return this.skills.backend;
	},
	get getSkillsPHP(): Indexed {
		return this.skills.PHP;
	},
	get getSkillsCSS(): Indexed {
		return this.skills.CSS;
	},
	get getSkillsDB(): Indexed {
		return this.skills.DB;
	},
	get getSkillsTechniques(): Indexed {
		return this.skills.techniques;
	},
	get getSkillsPackages(): Indexed {
		return this.skills.packages;
	},
	get getSkillsWordpress(): Indexed {
		return this.skills.wp;
	},
	get getSkillsXaaS(): Indexed {
		return this.skills.XaaS;
	},
	get getSkillsGit(): Indexed {
		return this.skills.version;
	},
	get getSkillsTDD(): Indexed {
		return this.skills.testing;
	},
	get getSkillsState(): Indexed {
		return this.skills.state;
	},
	get getSkillsBundlers(): Indexed {
		return this.skills.bundlers;
	},
	get getSkillsGameEngines(): Indexed {
